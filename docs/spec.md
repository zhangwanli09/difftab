...
4. 本阶段的收口记录与踩坑写入 `docs/journal.md`(倒序追加一节),`CLAUDE.md` 第 7 节**只**更新当前进度与未消费的交接条、并删去已被本阶段消费的交接;收口前核对 `CLAUDE.md` 仍在 200 行 / 20 KB 预算内
