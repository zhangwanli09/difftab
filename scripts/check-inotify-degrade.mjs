...
//
// **同时是那条"启动时配额已耗尽检测不到"的两条候选补法择一的判据**:下面的
...
/**
 * 安全轮询兜住那个缺口要等多久(`SAFETY_POLL_MS` 是 30s)。
 *
...
try {
  ...
  /**
   * 探索区:**只打印不断言**。这里量的是记下的那个已知缺口(根那一次注册的
   ...
   *
   * 这正是那个残留缺口的形态 —— 它不引出任何注册尝试,于是 ENOSPC 永远不浮出
